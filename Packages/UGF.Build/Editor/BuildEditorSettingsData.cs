...
namespace UGF.Build.Editor
{
    public class BuildEditorSettingsData : CustomSettingsData
    {
        ...
        [SerializeField] private string m_setupEnvironmentVariableName = "buildSetup";
        ...
        public string SetupEnvironmentVariableName { get { return m_setupEnvironmentVariableName; } set { m_setupEnvironmentVariableName = value; } }
